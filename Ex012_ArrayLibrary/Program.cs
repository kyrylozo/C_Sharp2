// Создание случайного массива заданного размера и нахождение первого встретившегося индекса
// интересующего нас числа 
...
int IndexOf(int[] collection, int find) // Создание метода "IndexOf",
                                        // возвращающего результат (содержит 2 аргумента)
{
    int count = collection.Length;
    int index = 0;
    //"int posit = 0;" - не оптимальное решение, так как при отсутствии искомого числа 
    //будет выдавать "0"
    int posit = -1; // - позволяет легко интерпретировать результат как ненайденный элемент
